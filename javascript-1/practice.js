...
let me = {firstName: 'Justin', state: 'Minnesota', age: 28, greeter: function(){
return 'Hello! My name is NAMEVALUE and I live in STATEVALUE';
}
}
...
let total = myNumbers.reduce((acc, ele) => acc + ele)
